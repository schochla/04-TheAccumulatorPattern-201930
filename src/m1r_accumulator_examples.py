...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Leo Schoch-Spana and Anna Staib.
...
#           s isn't defined, import math isn't explicitly written, r not defined, return outside of function
#              for k in range(r - s):
#                  count = 0
#                  if math.cos(r) > 0:
#                      count = 1
